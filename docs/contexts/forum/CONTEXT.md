...
- After URL parsing at an external boundary, **Forum Thread Routing**, native forum caches, and thread readers use Yamibo thread `tid` plus explicit qualifiers instead of persisting thread URLs as identity.
