...
- Manga reader projection JSON belongs in the Transparent JSON Cache rather than in GRDB `manga_chapter_documents` or `manga_chapter_document_images` tables.
