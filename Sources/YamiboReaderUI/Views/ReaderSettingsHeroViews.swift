...
struct ReaderBooksUnifiedSheetBackground: View {
...
struct ReaderBooksHeroSection: View {
...
struct ReaderBooksSettingsHeader: View {
    let palette: ReaderBooksSheetPalette
    let onClose: () -> Void
    let onConfirm: () -> Void
...
struct ReaderBooksPreviewMaskedContent: View {
    let settings: ReaderAppearanceSettings
    let palette: ReaderBooksSheetPalette
    let previewText: String
