...
struct NovelReaderPresentationSpreadCollectionViewport: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, UIGestureRecognizerDelegate {
        static let reuseIdentifier = "NovelReaderPresentationSpreadCollectionViewportCell"

        var parent: NovelReaderPresentationSpreadCollectionViewport
        ...
        init(parent: NovelReaderPresentationSpreadCollectionViewport) {
            self.parent = parent
        }
