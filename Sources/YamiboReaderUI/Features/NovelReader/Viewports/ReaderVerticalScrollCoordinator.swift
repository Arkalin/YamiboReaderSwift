...
final class ReaderVerticalScrollCoordinator: NSObject, UIGestureRecognizerDelegate {
...
struct ReaderScrollViewResolver: UIViewRepresentable {
...
final class ReaderScrollViewResolverView: UIView {
