...
public struct NovelReaderSegmentSemantics: Hashable, Sendable {
...
extension NovelReaderSegmentSemantics: Codable {
    private enum CodingKeys: String, CodingKey {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.init(
            ...
            chapterTitleRange: try container.decodeIfPresent(NovelCharacterRange.self, forKey: .chapterTitleRange),
            inlineTextStyles: try container.decodeIfPresent([NovelInlineTextStyleRange].self, forKey: .inlineTextStyles) ?? [],
            blockTextStyles: try container.decodeIfPresent([NovelBlockTextStyleRange].self, forKey: .blockTextStyles) ?? []
        )
    }
...
extension NovelReaderProjection {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        let sourceValues = try container.decodeIfPresent([NovelReaderSegmentSource?].self, forKey: .segmentSources)
        let threadID = try container.decode(String.self, forKey: .threadID)
        let view = try container.decode(Int.self, forKey: .view)
        let contentSource = try container.decodeIfPresent(ReaderProjectionContentSource.self, forKey: .contentSource) ?? .allPostsPage
        let schemaVersion = try container.decodeIfPresent(Int.self, forKey: .schemaVersion)
        let segmentSemantics = try container.decodeIfPresent([NovelReaderSegmentSemantics?].self, forKey: .segmentSemantics)
        let resolvedSemantics: [NovelReaderSegmentSemantics?]
...
extension NovelReaderProjection {
    ...
    private static func legacyChapterTitleRange(chapterTitle: String, text: String) -> NovelCharacterRange? {
