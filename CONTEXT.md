...
- Deferred macOS support must add a complete AppKit Runtime Adapter at the same seam; it must not preserve a separate shallow pagination or measurement Implementation.
