...
@Test func favoriteCategoriesCanBeCreatedRenamedReorderedAndDeletedToDefault() throws {
    ...
    let target = FavoriteContentTarget(kind: .normalThread, threadURL: try #require(URL(string: "https://bbs.yamibo.com/forum.php?mod=viewthread&tid=620")))
...
@Test func favoriteCollectionsCanBeCreatedRenamedRecoloredReorderedAndDissolved() throws {
    ...
    let target = FavoriteContentTarget(kind: .normalThread, threadURL: try #require(URL(string: "https://bbs.yamibo.com/forum.php?mod=viewthread&tid=621")))
...
@Test func favoriteItemSupportsMultipleLocationsIncludingSameCategory() throws {
    ...
    let target = FavoriteContentTarget(kind: .normalThread, threadURL: try #require(URL(string: "https://bbs.yamibo.com/forum.php?mod=viewthread&tid=622")))
...
@Test func favoriteTagsCanBeManagedWithoutChangingLocations() throws {
    var document = FavoriteLibraryDocument()
    let target = FavoriteContentTarget(kind: .normalThread, threadURL: try #require(URL(string: "https://bbs.yamibo.com/forum.php?mod=viewthread&tid=623")))
