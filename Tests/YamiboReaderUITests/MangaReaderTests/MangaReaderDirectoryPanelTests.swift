...
final class MangaReaderDirectoryPanelTests: XCTestCase {
    func testReaderViewWiresFullscreenControlsSheetAndViewportPlacement() throws {
        ...
        XCTAssertTrue(source.contains("previewPagesByTargetIndex: summary?.pagePreviewTargets ?? [:]"))
        ...
        XCTAssertTrue(source.contains("page: previewPagesByTargetIndex[preview.targetIndex]"))
